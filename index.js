...
const texts = [
  "Chúc Linh Trâm 18 tuổi thiệt xịn, sinh nhật chill hết cỡ nha!🥳🔥",
  "Vẫn là cô bạn hiền khô 🧸 dễ thương, hòa đồng, ai tiếp xúc cũng mê liền 💕🥺",
  "Tuổi mới sống  mình hết, học giỏi, yêu đẹp, cuộc sống auto xịn xò luôn🎁🎉",
];
